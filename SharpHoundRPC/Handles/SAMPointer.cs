...
{
    public class SAMPointer : SafeHandleZeroOrMinusOneIsInvalid
    {
        public SAMPointer() : base(true)
        {
        }

        public SAMPointer(IntPtr handle) : base(true)
        {
            SetHandle(handle);
        }

        public SAMPointer(IntPtr handle, bool ownsHandle) : base(ownsHandle)
        {
            SetHandle(handle);
        }
